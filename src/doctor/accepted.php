...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-item">
            ...
            <div class="submenu">
                <a href="accepted.php" class="submenu-link active d-flex align-items-center ps-4" style="padding-top: 3px; padding-bottom: 3px; margin: 5px 0;">
    ...
    <div class="main">
        ...
        <form method="get" class="d-flex align-items-center mt-3 gap-2 flex-wrap">
            ...
            <?php if ($search !== '' || $barangayFilter !== ''): ?>
                <a href="accepted.php" class="btn btn-outline-secondary"><i class="fas fa-times"></i> Clear</a>
            <?php endif; ?>
        </form>
        ...
        <div class="section-header">
            <div>LIST OF ACCEPTED APPLICANTS (<?= $total ?> total)</div>
