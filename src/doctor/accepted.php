...
<a href="accepted.php" class="btn btn-outline-secondary">
...
<div>
LIST OF ACCEPTED APPLICANTS (<?= $total ?> total)
</div>
...
<p class="text-muted mb-0">No accepted applicants found.</p>
</div>
...
<div>
<b><?= h($fullname ?: 'Unknown') ?></b>
</div>

<div style="font-size:12px;">
<?= h($barangay) ?>, Iligan City
</div>
...
style="background:#14b8a6;min-width:130px;padding:0.5rem 0.75rem;"
>
MEDICALLY ACCEPTED
</span>

<a href="<?= h($viewUrl) ?>" class="view-link text-primary text-decoration-none ms-5">
