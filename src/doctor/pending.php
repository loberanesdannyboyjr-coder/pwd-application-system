<?php
/** Displays pending CHO applications with search and barangay filter. */
session_start();
...
// Build query for pending applications (workflow_status = 'cho_review') - get barangay from draft data
$baseSql = "
    SELECT
        a.application_id,
        a.application_date,
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-item">
            ...
            <div class="submenu" style="max-height: 500px;">
                ...
                <a href="pending.php" class="submenu-link d-flex align-items-center ps-4 active" style="padding-top: 3px; padding-bottom: 3px; margin: 5px 0;">
    ...
    <div class="main">
        ...
        <form method="get" class="d-flex align-items-center mt-3 gap-2 flex-wrap">
            ...
            <?php if ($search !== '' || $barangayFilter !== ''): ?>
                <a href="pending.php" class="btn btn-outline-secondary"><i class="fas fa-times"></i> Clear</a>
            <?php endif; ?>
        </form>
