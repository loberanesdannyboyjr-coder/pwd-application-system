...
<img src="<?= APP_BASE_URL ?>/assets/pictures/white.png"
...
<?= $current == 'dashboard.php' ? 'bg-blue-700' : '' ?>">

<i class="fas fa-chart-line text-lg"></i>
<span class="sidebar-text hidden whitespace-nowrap">Dashboard</span>

</a>

<!-- Members -->
<a href="<?= ADMIN_BASE ?>/members.php"
class="flex items-center gap-4 px-4 py-3 hover:bg-blue-700 transition
<?= $current == 'members.php' ? 'bg-blue-700' : '' ?>">

<i class="fas fa-users text-lg"></i>
<span class="sidebar-text hidden whitespace-nowrap">Members</span>

</a>

<!-- SUPER ADMIN ONLY -->
<?php if (($_SESSION['admin_role'] ?? $_SESSION['role'] ?? '') === 'super_admin'): ?>
<a href="<?= ADMIN_BASE ?>/manage_admins.php"
class="flex items-center gap-4 px-4 py-3 hover:bg-blue-700 transition
<?= $current == 'manage_admins.php' ? 'bg-blue-700' : '' ?>">

<i class="fas fa-user-cog text-lg"></i>
<span class="sidebar-text hidden whitespace-nowrap">User Management</span>
...
<!-- For Review -->
<a href="<?= ADMIN_BASE ?>/application_review.php"
class="flex items-center gap-4 px-8 py-3 hover:bg-blue-700 transition
<?= $current == 'application_review.php' ? 'bg-blue-700' : '' ?>">
...
<!-- Approved -->
<a href="<?= ADMIN_BASE ?>/accepted.php"
class="flex items-center gap-4 px-8 py-3 hover:bg-blue-700 transition
<?= $current == 'accepted.php' ? 'bg-blue-700' : '' ?>">
...
<!-- Disapproved -->
<a href="<?= ADMIN_BASE ?>/denied.php"
class="flex items-center gap-4 px-8 py-3 hover:bg-blue-700 transition
<?= $current == 'denied.php' ? 'bg-blue-700' : '' ?>">
